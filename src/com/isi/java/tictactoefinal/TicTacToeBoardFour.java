...
// */
//public class TicTacToeBoardFour extends JFrame implements ITicTacToeView
//{
...
//	
//	
//	public TicTacToeBoardFour(ITicTacToeModel gameChecker)
//	{
//		super("TIC-TAC-TOE");
//		
...
//		{
//			for (int j = 0; j < mark4[i].length; j++) 
//			{
//				mark4[i][j] = new JButton("X/O");
//				mark4[i][j].setCursor(new Cursor(HAND_CURSOR));
//			}
//		}	
//		
//		// labels created
...
//		game_board.setLayout(new GridLayout(4, 4, 5, 5));
...
//	{
//		// create game board
//		for (int y = 0; y < mark4.length; y++) 
//		{
//			for (int x = 0; x < mark4.length; x++)
//			{
//				game_board.add(mark4[x][y]);
//			}
//		}
//		
//		// add game board
...
//				final int g = i;
//				final int h = j;
//				mark4[i][j].addActionListener((ActionEvent e)->
//				{
//					
//					try
//					{
//						char resultChar = gameChecker.makeMove(g, h , true);
//						switch (resultChar) 
//						{
...
//							break;
//						}
//						playerTurn(gameChecker.getTurn(), g, h);
//						
...
//	{
//		for (int k = 0; k < mark4.length; k++) 
//	  		for (int l = 0; l < mark4.length; l++) 										
//	  			{
//	  			mark4[k][l].setText(buttonText);
//	  			}
//		player1.setText("PLAYER O");
//		player2.setText("PLAYER X");
...
//	*/
//	private void playerTurn(boolean player, int x, int y)
//	{
//		if (player)
//		{
